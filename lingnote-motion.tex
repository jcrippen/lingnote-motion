...
Two perfective forms have dedicated perfective aspect prefixes: \fm{wu-} \~\ \fm{w-} (also Teslin, Carcross \fm{m-}) and \fm{u-}.
The \fm{u-} is used only in certain forms of verbs that belong to the \fm{∅} conjugation class and the \fm{wu-} \~\ \fm{w-} is used for the other three conjugation classes (\fm{n}, \fm{g̱}, \fm{g}).
...
The perfective aspect always has a perfective prefix \fm{wu-} \~\ \fm{w-} or \fm{u-} that blocks the presence of a conjugation prefix, but unlike the progressive and prospective aspects there is no preverb that distinguishes conjugation class membership.
...
\begingl
	...
	\glb	aan -t {} g̱- x̱a- \rt[¹]{gut} -μμL //
	\glc	town -\xx{pnct} \xx{zcnj}\· \xx{mod}- \xx{1sg·s}- \rt[¹]{go·\xx{sg}} -\xx{var} //
